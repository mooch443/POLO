...
def loc_nms(preds, scores, radii, dor_thres) -> torch.Tensor:
    ...
    dor_matrix = loc_dor_pw(locs_ordered, locs_ordered, radii_ordered)
...
def non_max_suppression_loc(
    ...
    for xi, x in enumerate(prediction):  # image index, image inference
        ...
        torch.save(x_out, f"/home/giacomo/projects/ennedi_herdcount_POLO/results/experiments/eval_vis/pre_nms.pt")
        torch.save(post_out, f"/home/giacomo/projects/ennedi_herdcount_POLO/results/experiments/eval_vis/post_nms.pt")
